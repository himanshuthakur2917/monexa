...
import { AlertCircle, ArrowDownRight, Eye, EyeOff } from "lucide-react";
            ...
            <section className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    <div className="flex flex-col gap-3 w-full ">
                        <h1 className="animate-element relative mx-auto animate-delay-100 text-4xl md:text-3xl font-semibold leading-tight">
                            {title}
                        </h1>
                        ...
                        <form className="space-y-3 " onSubmit={onSignIn}>
                                ...
                                <GlassInputWrapper>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-transparent text-[0.85rem] leading-0.5 p-4 pr-12 rounded-lg focus:outline-none"
                                        />
                                        <button
                                            type="button"
                                            onClick={() =>
                            ...
                            <button
                                type="submit"
                                className="animate-element animate-delay-600 w-full flex gap-3 justify-center items-center rounded-2xl bg-primary py-3 font-medium text-primary-foreground hover:bg-primary/90 transition-colors"
                            >
                                Continue <ArrowDownRight></ArrowDownRight>
                            </button>
                        </form>
                        ...
                        <button
                            ...
                            className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-3 hover:bg-violet-950 transition-colors"
                        >
                            <GoogleIcon />
